    ...
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen">
      <div>
        <div className="mb-8">
          ...
          <h1 className="mb-2 font-headline text-3xl font-extrabold tracking-tight text-slate-100 sm:text-4xl">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          <section className="flex flex-col gap-8 lg:col-span-8">
            <div className="staff-glass-card rounded-2xl p-6 sm:p-8">
              <h2 className="mb-6 flex items-center gap-2 font-headline text-lg font-bold text-cyan-300">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="flex flex-col gap-2">
                  ...
                  <select className="rounded-xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm text-slate-100 outline-none transition focus:border-cyan-300/60 focus:ring-1 focus:ring-cyan-300/50">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    className="rounded-xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm text-slate-100 outline-none transition focus:border-cyan-300/60 focus:ring-1 focus:ring-cyan-300/50"
                    type="time"
                    defaultValue="09:00"
                  />
                </div>
              ...
              <div className="mt-8 flex flex-col gap-2">
                ...
                <textarea
                  className="min-h-[120px] resize-none rounded-xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm text-slate-100 outline-none transition placeholder:text-slate-500 focus:border-cyan-300/60 focus:ring-1 focus:ring-cyan-300/50"
            ...
            <div className="staff-glass-card rounded-2xl p-6 sm:p-8">
              <h2 className="mb-6 flex items-center gap-2 font-headline text-lg font-bold text-purple-300">
              ...
              <div className="flex flex-col gap-8">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="group flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-white/10 bg-slate-950/30 p-8 text-center transition hover:border-purple-300/30 hover:bg-slate-800/40">
                    <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-purple-400/15 text-purple-300 transition group-hover:scale-110">
                      <span className="material-symbols-outlined">cloud_upload</span>
                    </div>
                    <p className="text-sm font-medium text-slate-100">Click to upload or drag and drop</p>
                    <p className="mt-1 text-xs text-slate-500">PNG, JPG or PDF (max. 5MB)</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    className="min-h-[88px] resize-none rounded-xl border border-white/10 bg-slate-900/60 px-4 py-3 text-sm text-slate-100 outline-none transition placeholder:text-slate-500 focus:border-purple-300/60 focus:ring-1 focus:ring-purple-300/40"
            ...
            <div className="flex flex-col-reverse items-stretch justify-end gap-4 pb-12 sm:flex-row sm:items-center">
              <Link
                href="/staff/change-request"
                className="rounded-xl px-8 py-3 text-center text-sm font-bold text-slate-100 transition hover:bg-slate-800/40"
              >
                Cancel
              </Link>
              <button
                type="button"
                className="rounded-xl bg-gradient-to-br from-cyan-300 to-cyan-400 px-10 py-3 text-sm font-extrabold uppercase tracking-widest text-[#004d57] shadow-[0_0_20px_rgba(129,236,255,0.3)] transition hover:scale-[1.02] active:scale-95"
              >
                Submit Request
              </button>
            </div>
          ...
          <aside className="flex flex-col gap-8 lg:col-span-4">
            <div className="staff-glass-card overflow-hidden rounded-2xl border-t-2 border-red-300/50">
              <div className="bg-red-400/10 p-6">
            ...
            <div className="staff-glass-card rounded-2xl p-6">
              <h3 className="mb-6 font-headline text-sm font-bold uppercase tracking-widest text-slate-100">Approval Workflow</h3>

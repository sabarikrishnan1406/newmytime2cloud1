...
<div class="page">
  ...
  <div class="details">
    ...
    <div class="col">
      ...
      <div class="row"><span class="label">Status</span><span class="value" style="text-transform:uppercase">{{ $record->status }}</span></div>
    </div>
  </div>
  ...
  <div class="attendance">
    ...
    <p>
      ...
      Late: {{ $record->late_days }} days &nbsp;|&nbsp;
      OT: {{ $record->ot_hours }}hrs
    </p>
  </div>
  ...
  <div class="tables">
    <div class="col">
      <table class="earnings">
        ...
        <tbody>
          <tr><td>Basic Salary</td><td>{{ number_format($record->basic_salary) }}</td></tr>
          <tr><td>House Allowance</td><td>{{ number_format($record->house_allowance) }}</td></tr>
          <tr><td>Transport Allowance</td><td>{{ number_format($record->transport_allowance) }}</td></tr>
          <tr><td>Food Allowance</td><td>{{ number_format($record->food_allowance) }}</td></tr>
          <tr><td>Medical Allowance</td><td>{{ number_format($record->medical_allowance) }}</td></tr>
          <tr><td>Other Allowance</td><td>{{ number_format($record->other_allowance) }}</td></tr>
          <tr><td>Overtime</td><td>{{ number_format($record->ot_amount) }}</td></tr>
          @if($record->bonus > 0)<tr><td>Bonus</td><td>{{ number_format($record->bonus) }}</td></tr>@endif
          @if($record->incentive > 0)<tr><td>Incentive</td><td>{{ number_format($record->incentive) }}</td></tr>@endif
          @if($record->arrears > 0)<tr><td>Arrears</td><td>{{ number_format($record->arrears) }}</td></tr>@endif
          @if($record->reimbursement > 0)<tr><td>Reimbursement</td><td>{{ number_format($record->reimbursement) }}</td></tr>@endif
          <tr class="total"><td>Gross Earned</td><td>{{ number_format($record->gross_earned) }}</td></tr>
        </tbody>
      </table>
    </div>
    <div class="col">
      <table>
        ...
        <tbody>
          <tr><td>Absence Deduction</td><td>{{ number_format($record->absence_deduction) }}</td></tr>
          <tr><td>Late Deduction</td><td>{{ number_format($record->late_deduction) }}</td></tr>
          <tr><td>Loan Deduction</td><td>{{ number_format($record->loan_deduction) }}</td></tr>
          <tr><td>Advance Deduction</td><td>{{ number_format($record->advance_deduction) }}</td></tr>
          @if($record->fine_amount > 0)<tr><td>Fine</td><td>{{ number_format($record->fine_amount) }}</td></tr>@endif
          @if($record->other_deduction > 0)<tr><td>Other Deduction</td><td>{{ number_format($record->other_deduction) }}</td></tr>@endif
          <tr class="total"><td>Total Deductions</td><td>{{ number_format($record->total_deduction) }}</td></tr>
        </tbody>
      </table>
    </div>
  </div>
  ...
  <div class="net-salary">
    ...
    <span class="amount">{{ number_format($record->net_salary) }}</span>
  </div>
